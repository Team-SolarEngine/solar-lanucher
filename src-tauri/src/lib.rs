/*
 * PLEASE NOTE THIS;
 *   do NOT remove any warning that were generated by the compiler.
 *   shit will break if you do. so please, don't try to "fix" them.
 * 
 *   the reason why they were generated by the compiler is because
 *   some of the code is exclusive to Linux. so removing the "warnings"
 *   will cause the compiler to freak out and crash in Linux.
 */
